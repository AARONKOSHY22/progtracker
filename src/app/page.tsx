    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="flex flex-col items-center bg-gray-800 p-4 rounded-md">
          ...
          <a href="#" className="text-xs text-blue-400">Data Structures & Algorithms for Beginners</a>
        </div>
        <div className="flex flex-col items-center bg-gray-800 p-4 rounded-md">
          <input type="checkbox" className="mb-2" />
        ...
        <div className="flex flex-col items-center bg-gray-800 p-4 rounded-md">
          ...
          <a href="#" className="text-xs text-blue-400">Advanced Algorithms</a>
        </div>
      </div>
          ...
          <tbody>
            <tr className="bg-gray-800">
              <td className="px-4 py-2">
                <input type="checkbox" checked className="form-checkbox text-green-500" readOnly />
              </td>
              <td className="px-4 py-2">
                <span className="text-yellow-500">&#9733;</span>
              </td>
              <td className="px-4 py-2">
                <a href="#" className="text-blue-400">Contains Duplicate</a>
              </td>
            ...
            <tr className="bg-gray-800">
              ...
              <td className="px-4 py-2">
                <a href="#" className="text-blue-400">Valid Anagram</a>
              </td>
              <td className="px-4 py-2">Easy</td>
              <td className="px-4 py-2">
                <span>&#x1F4FA;</span>
            ...
            <tr className="bg-gray-800">
              ...
              <td className="px-4 py-2">
                <a href="#" className="text-blue-400">Two Sum</a>
              </td>
              <td className="px-4 py-2">Easy</td>
              <td className="px-4 py-2">
                <span>&#x1F4FA;</span>
            ...
            <tr className="bg-gray-800">
              ...
              <td className="px-4 py-2">
                <a href="#" className="text-blue-400">Group Anagrams</a>
              </td>
            ...
            <tr className="bg-gray-800">
              ...
              <td className="px-4 py-2">
                <a href="#" className="text-blue-400">Top K Frequent Elements</a>
              </td>
              <td className="px-4 py-2">Medium</td>
              <td className="px-4 py-2">
                <span>&#x1F4FA;</span>
            ...
            <tr className="bg-gray-800">
              ...
              <td className="px-4 py-2">
                <a href="#" className="text-blue-400">Encode and Decode Strings</a>
              </td>
              <td className="px-4 py-2">Medium</td>
              <td className="px-4 py-2">
                <span>&#x1F4FA;</span>
            ...
            <tr className="bg-gray-800">
              ...
              <td className="px-4 py-2">
                <a href="#" className="text-blue-400">Product of Array Except Self</a>
              </td>
              <td className="px-4 py-2">Medium</td>
              <td className="px-4 py-2">
                <span>&#x1F4FA;</span>
